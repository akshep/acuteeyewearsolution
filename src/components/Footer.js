          ...
          <div className="row">
            <div className="col-4">
              ...
              <address className="text-white fs-6">Acute Eyewear,
                ...
                <a
                  href="tel:+91 9359395940"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +91 9359395940
                </a>
                <a
                  href="acuteeyewear@gmail.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  acuteeyewear@gmail.com
                </a>
                <div className="social_icons d-flex align-items-center gap-30 mt-4">
                <a className="text-white" href="https://www.instagram.com/akshepyadav/">
                  <BsInstagram className="text-white fs-4"/>
                </a>
                <a className="text-white" href="https://www.youtube.com/@AYKiRides/videos">
                 <BsYoutube className="text-white fs-4"/>
                </a>
                <a className="text-white" href="https://www.linkedin.com/in/akshep-yadav/">
